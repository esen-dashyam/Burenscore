export default async (customerInfo) => {
  let customer = {
    ...
    o_c_bank_code                  : customerInfo.o_c_bank_code,
    o_c_branchcode                 : customerInfo.o_c_branchcode,
    is_aco_c_isorganizationtive    : customerInfo.is_aco_c_isorganizationtive,
    ...
    o_c_sectorcodes                : customerInfo.o_c_sectorcodes,
    o_c_sectorcode                 : customerInfo.o_c_sectorcode,
    ...
    o_fitchrating                  : customerInfo.o_fitchrating,
    o_sandp_rating                 : customerInfo.o_sandp_rating,
    o_moodysrating                 : customerInfo.o_moodysrating,
