...
const schema = Joi.object({
  o_c_loanline_type       : Joi.string().valid(Object.keys(APPENDIX.APPENDIX_L)).required(),
  ...
  o_c_loanline_loanclasscode : Joi.string().valid(Object.keys(APPENDIX.APPENDIX_EO)).optional().allow([null, ""]),
  o_c_loanline_balance       : Joi.number().required(),
  o_c_loanline_isapproved    : Joi.number().min(0).max(1).allow([null, ""]),
